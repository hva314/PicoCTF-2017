...
Official Write-up has been moved to </br>
[Blue's Little Blog](https://hva314.github.io/blog/2017/04/23/PicoCTF-2017-Crypto-Writeup.html)
...
The method is called Reconstruction RSA Private Key
There are some articles online, but here is a brief explaination:
we have: 
```python
dp = d mod p-1
```
